...
<div style="height:100px;width:100%;"></div>
    ...
    <div style="height:500px;width:100%;font-size:15px;color:black;text-align:center;">
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="No" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" RowStyle-Height="20px" Width="681px" HeaderStyle-Height="30px" >
