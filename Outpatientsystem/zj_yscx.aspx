<%@ Page Title="" Language="C#" MasterPageFile="~/Navigate.Master" AutoEventWireup="true" CodeBehind="zj_yscx.aspx.cs" Inherits="Outpatientsystem.zj_yscx" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style>
        .left{float:left;width:25%;color:aqua;font-size:15px;}
        .right{float:right;width:75%;}
    </style>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <div class="left" >
        <asp:TreeView ID="tree_doc" runat="server" OnSelectedNodeChanged="tree_doc_SelectedNodeChanged">
            <Nodes>
