...
namespace Outpatientsystem.BusinessLogicLayer
{
    public class DoctorBll:IDoctorBll
    {
        ...
        private void HandleUserNotExist(Doctor user)
        {
            if (user == null)
            {
        ...
        /// </summary>
        /// <param name="user">医生</param>
        private void HandleUserNotActivated(Doctor user)
        {
            if (!user.IsActivated)
            {
        ...
        /// </summary>
        /// <param name="user">医生</param>
        private void HandleUserLoginFailTooManyTimes(Doctor user)
        {
        ...
        /// </summary>
        /// <param name="user">医生</param>
        private void HandleUserLoginFail(Doctor user)
        {
            user.LoginFailCount++;
            this.DoctorDal.Update(user);
        }
        ...
        private void HandleUserPasswordNotMatch(Doctor user, string password)
        {
        ...
        /// </summary>
        /// <param name="user">医生</param>
        private void HandleUserLoginOk(Doctor user)
        {
        ...
        /// <param name="password">密码</param>
        /// <returns>医生</returns>
        public Doctor LogIn(string userNo, string password)
        {
            this.HasLoggedIn = false;
            Doctor user = this.DoctorDal.Select(userNo);
            try
            {
        ...
        /// <param name="password">密码</param>
        /// <returns>医生</returns>
        public Doctor SignUp(string userNo, string password, string name, string phone, string email, bool gender)
        {
