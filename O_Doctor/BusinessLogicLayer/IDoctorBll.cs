...
namespace Outpatientsystem.BusinessLogicLayer
{
    internal interface IDoctorBll
    {
        ...
        /// <returns>用户</returns>
        Doctor LogIn(string userNo, string password);
        /// <summary>
        /// 注册；
        /// </summary>
        /// <param name="userNo">医生号</param>
        /// <param name="password">密码</param>
        /// <returns>医生</returns>
        Doctor SignUp(string userNo, string password, string phone, string email, string name, bool gender);
        /// <summary>
        /// 开药
        /// </summary>
