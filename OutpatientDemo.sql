...
INSERT tb_User
(No,Password,Name,Gender,Phone,Email,Birthday)
VALUES
...
('3210707015',HASHBYTES('MD5','1'),'官祥杰','男','18120795092','319665159@qq.com','2002-11-29'),
('3210707002',HASHBYTES('MD5','1'),'刘兰' , '女','18120795092','319665159@qq.com','2003-6-28'),
('3210707003',HASHBYTES('MD5','1'),'吴争宇','男','18120795092','319665159@qq.com','2004-1-23'),
('3210707004',HASHBYTES('MD5','1'),'廖丽珍','女','18120795092','319665159@qq.com','2002-7-14'),
('3210707005',HASHBYTES('MD5','1'),'罗清香','女','18120795092','319665159@qq.com','2002-8-25')
		...
		CHAR(3)
			NOT NULL
				CONSTRAINT fk_Doctor_ProtitleNo
					FOREIGN KEY(KeshiNo) 
				REFERENCES tb_Keshi(No)
				CONSTRAINT ck_Doctor_ProtitleNo
					CHECK(ProtitleNo LIKE'[0-9]'),
)
...
--药品插入
INSERT INTO tb_Drug(No,Name,Num,UNIT,TypeNo,Content,PharmacyNo)VALUES
	('AAAA01','复方利血平片','1000','瓶','1001','适用于早期和中期高血压病。','101'),
	('AAAA02','酒石酸美托洛尔片','1000','盒','1001','用于治疗高血压、心绞痛、心肌梗死、肥厚型心肌病、主动脉夹层、心律失常、甲状腺功能亢进、心脏神经官能症等。','101'),
	('BAAA01','参茸片','10000','板','1003','补气血，益心肾。用于体虚神怯，心悸气短，腰膝酸软。','101'),
	('BAAA02','参茸丸','3000','丸','1003','滋阴补肾，益精助阳。用于肾虚肾寒，阳痿早泄，梦遗滑精、腰腿酸痛，形体瘦弱，气血两亏。','101'),
	('ABAA01','小儿止咳糖浆','1000','瓶','1004','祛痰，镇咳。用于小儿感冒引起的咳嗽。','101'),
	('ACAA01','定坤丹','7800','丸','1002','滋补气血，调经舒郁。用于气血两虚、气滞血瘀所致的月经不调、行经腹痛。','101'),
	('AAAD01','方利血平片','1000','瓶','1001','主治高血压','101'),
	('ACBA01','益母草颗粒','1000','袋','1002','活血调经。用于血瘀所致的月经不调，症见经水量少。','101'),
	('AACA01','小儿氨酚黄那敏片','1000','盒','1004','适用于缓解儿童普通感冒及流行性感冒引起的发热、头痛、四肢酸痛、打喷嚏、流鼻涕、鼻塞、咽痛等症状。','101'),
	('AAAA03','卡托普利片','1000','板','1001','1.高血压；2.心力衰竭。','101'),
	('AAAA04','降糖宁胶囊','1000','瓶','1001','益气，养阴，生津。用于糖尿病属气阴两虚者。','101')
...
IF OBJECT_ID('tb_Booking')IS NOT NULL
	...
	INSERT INTO tb_Booking(No,UserNo,WorkNo)VALUES
	('101','3210707001','101');
...
GO
CREATE VIEW YYView
AS SELECT B.No AS '预约号', U.No AS  '患者编号',U.Name AS '患者姓名',W.Time AS '预约时间',W.DoctorNo AS '医生编号', IIF(D.No IS NULL,'否','是') AS '是否就诊' FROM tb_Booking AS B
